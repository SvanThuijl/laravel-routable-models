...
use Svanthuijl\Routable\Tests\TestSupport\Database\Factories\ExampleWithJsonFactory;
...
class ExampleWithJson extends Model implements HasRoutes
{
    use HasFactory;
    ...
    {
        return ExampleWithJsonFactory::new();
    }
}
